...
_The mean of the character varaibles and factor variables could not be computed because they are not numeric or logical. Thus, do not have assigned numeric values, which is needed in computation of a mean. A mean can ony be computated from numbers_
